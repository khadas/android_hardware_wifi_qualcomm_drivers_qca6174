...
mkdir temp
cd temp
wget https://source.codeaurora.org/quic/la/platform/external/bluetooth/bluedroid/snapshot/bluedroid-7ee41708ce979ae1051e03f8f98dff3df3413124.tar.gz
...
cd temp
wget https://source.codeaurora.org/quic/la/platform/hardware/qcom/bt/snapshot/bt-58e312a0bc18be867f8dfebbce8e3f08f19a7651.tar.gz
