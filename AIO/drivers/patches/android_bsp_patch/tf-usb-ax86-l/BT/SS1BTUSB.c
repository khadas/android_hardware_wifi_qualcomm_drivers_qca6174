...
#define CHIP_IS_TUFFELO
#ifdef CHIP_IS_TUFFELO
#define ROME3_0_USB_RAMPATCH_FILE	"ar3k/rampatch_tlv_usb_tf_1.0.tlv"
#define ROME3_0_USB_NVM_FILE		"ar3k/nvm_tlv_usb_tf_1.0.bin"

#define ROME3_2_USB_RAMPATCH_FILE	"ar3k/rampatch_tlv_usb_tf_1.1.tlv"
#define ROME3_2_USB_NVM_FILE		"ar3k/nvm_tlv_usb_tf_1.1.bin"
#else
...
static struct usb_device_id BluetoothDeviceIDTable[] =
{
   ...
   /* Qualcomm Devices.                                                  */
   { USB_DEVICE(0x0CF3, 0x3004) },//tf 1.0
   { USB_DEVICE(0x0CF3, 0xE500) },//tf 1.1
...
static int ath3k_load_patch(struct usb_device *udev)
{
	...
	if (fw_version.rom_version == ROME1_1_USB_CHIP_VERSION) {
		...
		BT_DBG("Chip Detected as ROME3.2");
